...
**Entry count:** 69 concerns (48 resolved, 21 open) + 5 disagreements (4 resolved)
...
### C-186: A views-frames version bump can silently change reporting's forecast numbers (behavioural drift under a fixed CONFORMANCE_FLOOR)
