...
| Cross-refs | C-112 (bundle staleness observability — the stamp this entry extends; reciprocal); C-192 (sibling cross-repo contract-assurance theme); epic #230; views-datafactory#341 / views-postprocessing#123 (coding-decision venue); the S6 ADR will document the interim status + path forward. |
